...
#plan:ask chatgpt
#question: how do I use pygame in python?
#Response: Images and Sounds: You can load images (pygame.image.load()) and play sounds (pygame.mixer.Sound()).    Keyboard and Mouse Input: You can capture keyboard presses and mouse clicks for interactivity.    Sprites: Pygame has a system for handling multiple objects or characters on the screen called sprites.
#I learned how to use pygame and I apply that to the entirety of this project
...
#I learned how some of the code works, the class, the game loop(), variables, and how it detects the keyboards inputs.